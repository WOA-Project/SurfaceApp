...
namespace USBFunctionMode
{
    ...
    {
        private Registry reg => SurfaceApp.App.Registry;
        ...
        public static string GetFunctionRoleDescription(string FunctionModeName)
        {
            switch (FunctionModeName.ToLower())
            {
                ...
                case "retailconfig":
                    return "Retail mode of the USB port. Provides File transfer capabilities, video stream support, and connection with THOR2/WPinternals/Windows Device Recovery Tool/Surface Software Updater Pro.";
                case "dplcompositeconfig":
